...
namespace ProjetWinform
{
    public partial class Comptes : Form
    {
        ...
        private void Comptes_Load(object sender, EventArgs e)
        {
            ...
            lstCpte.Add(new CompteBancaire("aaaa", 1500));
            lstCpte.Add(new CompteBancaire("iiii", 5000));
            lstCpte.Add(new CompteBancaire("eeee", 300000));
            lstCpte.Add(new CompteBancaire("oooo", 2000));
        ...
        private void btnAjouter_Click(object sender, EventArgs e)
        {
            ...
            CompteBancaire cb = new CompteBancaire(num, solde);
        ...
        {
            if(MessageBox.Show("Etes vous sur de vouloir supprimer le compte ? ", "Suppression d'un compte", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                CompteBancaire cb = (CompteBancaire)lstCompte.SelectedItem;
        ...
        //Ecriture dans un fichier (serialisation: conversion objet vers binaire)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Filter = "fichier binaire(*.bin) | *.bin| tous les fichiers (*.*) | *.*";
        ...
        {
            openFileDialog1.InitialDirectory = "c:/";
            openFileDialog1.Filter = "fichier binaire(*.xml) | *.xml| tous les fichiers (*.*) | *.*";
            openFileDialog1.FileName = "";
        ...
        {
            openFileDialog1.InitialDirectory = "c:/";
            openFileDialog1.Filter = "fichier binaire(*.json) | *.json| tous les fichiers (*.*) | *.*";
            openFileDialog1.FileName = "";
        ...
        {
            openFileDialog1.InitialDirectory = "c:/";
            openFileDialog1.Filter = "fichier binaire(*.csv) | *.csv| tous les fichiers (*.*) | *.*";
            openFileDialog1.FileName = "";
