...
namespace ProjetWinform
{
    public partial class Form1 : Form
    {
        ...
        {
            usersManagmentToolStripMenuItem.Enabled = false;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            service.addUser(u);
            MessageBox.Show("User inséré dans la BD");
        }
        ...
        {
            if(MessageBox.Show("Etes-vous sûr de vouloir vous déconnectez?", "Déconnexion", 
